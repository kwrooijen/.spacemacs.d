...
;; (bind-key* "s-q" 'undefined)
;; (bind-key* "s-w" 'undefined)
;; (bind-key* "s-e" 'undefined)
;; (bind-key* "s-r" 'undefined)
;; (bind-key* "s-t" 'undefined)
;; (bind-key* "s-y" 'undefined)
;; (bind-key* "s-u" 'undefined)
;; (bind-key* "s-i" 'undefined)
;; (bind-key* "s-o" 'undefined)
;; (bind-key* "s-p" 'undefined)
;; (bind-key* "s-a" 'undefined)
;; (bind-key* "s-s" 'undefined)
;; (bind-key* "s-d" 'undefined)
;; (bind-key* "s-f" 'undefined)
;; (bind-key* "s-g" 'undefined)
;; (bind-key* "s-h" 'undefined)
;; (bind-key* "s-j" 'undefined)
;; (bind-key* "s-k" 'undefined)
;; (bind-key* "s-l" 'undefined)
;; (bind-key* "s-z" 'undefined)
;; (bind-key* "s-x" 'undefined)
;; ;; (bind-key* "s-c" 'undefined)
;; ;; (bind-key* "s-v" 'undefined)
;; (bind-key* "s-b" 'undefined)
;; (bind-key* "s-n" 'undefined)
;; (bind-key* "s-m" 'undefined)
;; (bind-key* "s-Q" 'undefined)
;; (bind-key* "s-W" 'undefined)
;; (bind-key* "s-E" 'undefined)
;; (bind-key* "s-R" 'undefined)
...
;; (bind-key* "s-(" 'undefined)
;; (bind-key* "s-)" 'undefined)
;; (bind-key* "s-1" 'undefined)
;; (bind-key* "s-2" 'undefined)
;; (bind-key* "s-3" 'undefined)
;; (bind-key* "s-4" 'undefined)
;; (bind-key* "s-5" 'undefined)
;; (bind-key* "s-6" 'undefined)
;; (bind-key* "s-7" 'undefined)
;; (bind-key* "s-8" 'undefined)
;; (bind-key* "s-9" 'undefined)
;; (bind-key* "s-&" 'undefined)
